...
| `Esc` | Выйти из цикла: A = 0:00, B = конец трека, применяется сразу |
| `+` / `−` | Скорость ±0,025 |
| `Ctrl + O` | Выбрать трек |
...
- «Выйти из цикла» делает фрагментом весь трек; если трек играл внутри A–B, он сразу продолжает играть дальше до конца записи.
